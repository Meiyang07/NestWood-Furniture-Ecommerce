...
<head>
    ...
    <title>404 — Page Not Found | NestWood</title>
...
<body>
    <div class="error-wrapper">
        ...
        <p class="error-message">
            ...
            or it never existed. Let's get you back on track.
        </p>
        ...
        <div class="error-buttons">
            ...
            <a href="${pageContext.request.contextPath}/user/browse" class="btn btn-secondary">
                Browse Furniture
            </a>
        </div>
